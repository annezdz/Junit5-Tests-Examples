...
public class DisabledEnabledTest {
    ...
    @Test
    @DisabledIfSystemProperty(named = "env", matches = "staging", disabledReason = "Disabled for demo of @DisabledOnOs")
    void thirdTest(){
    ...
    @Test
    @DisabledIf(value = "provider", disabledReason = "Disabled for demo of @DisabledOnOs")
    void fifthTest(){
